...
import { View, Text, TouchableOpacity, Image, Animated, Platform, StatusBar } from 'react-native';
            ...
            {bottom_tabs.map((item, index) => {
                return (
                    <TouchableOpacity
                        ...
                        ref={item.ref}
                        style={{
                            flex: 1, paddingHorizontal: 15, alignItems: "center", justifyContent: 'center'
                        }}
